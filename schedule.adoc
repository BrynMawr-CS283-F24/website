...
* Topics: A simple vehicle model. Steering behaviors.
* Reading: Game AI by Example by Mat Buckland
* Lab: **Quiz 4** link:studyguide4.html[Study Guide]
...
|*Demos, Building for different platforms (Desktop/Web/Mobile/VR/AR)*
