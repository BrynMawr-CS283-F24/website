...
You will need to write two Unity scripts for this assignment. 
...
NOTE: You are welcome to use the cat asset that I have been using for demos

* link:https://assetstore.unity.com/packages/3d/characters/animals/lowpoly-toon-cat-lite-66083[Lowpoly Toon Cat by Omabuarts Studio]
