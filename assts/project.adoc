...
NOTE: You won't be able to commit your executable to your repository without modifying your `.gitignore` file carefully. Instead, you can upload your executable folder to a shared fileserver and email the instructor with the link. 
