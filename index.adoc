...
* link:assts/project.html[Game Project Final Submissions]: Due Friday, December 13
* Additional Office Hours Dec 16th, 1PM - 2PM
* link:https://forms.gle/cpFXDG6dgpLDpFXp8[Final Exam Sign-up Form]: If you want to take the final, sign-up here. The final is 1.5 hours, closed book.
